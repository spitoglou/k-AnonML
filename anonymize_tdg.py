#!/usr/bin/env python3
"""
Simple TDG (Top-Down Greedy) k-Anonymity Script

Usage: python anonymize_tdg.py --dataset adult --k 5
"""
...
def parse_arguments():
    parser = argparse.ArgumentParser(description='Run TDG k-anonymity algorithm')
    ...
    parser.add_argument('--output', help='Output file (default: [dataset]_tdg_k[k].csv)')
...
def main():
    ...
    # Setup output file
    if not args.output:
        args.output = f"{args.dataset}_tdg_k{args.k}.csv"
    
    print("=" * 60)
    print("TDG (TOP-DOWN GREEDY) K-ANONYMITY ANONYMIZATION")
    print("=" * 60)
    ...
    try:
        ...
        # Run anonymization
        print(f"Running TDG k-anonymization (k={args.k})...")
